...
Implemented the main color config file [`config`](https://github.com/nordtheme/terminator/blob/develop/src/config). (@svengreb, #1, 0f06e46a)

Implementd a [`install.sh`](https://github.com/nordtheme/terminator/blob/develop/install.sh) shell script for an automated installation . (@svengreb, #2, f26407c0)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/terminator/blob/develop/README.md#installation) and in the [project wiki](https://github.com/nordtheme/terminator/wiki).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/terminator/develop/src/assets/scrot-colortest.png"/><br />
  </picture>
